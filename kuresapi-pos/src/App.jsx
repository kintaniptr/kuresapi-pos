...
function InvoiceView({ invoice, onClose, isMobile }) {
  ...
  return (
    <div style={{maxWidth:480,margin:"0 auto",fontFamily:"'Segoe UI',sans-serif"}}>
      ...
      {/* ── Receipt Card ── */}
      <div className="print-area" style={{background:"#fff",borderRadius:20,overflow:"hidden",boxShadow:"0 8px 40px rgba(45,75,160,0.15)",border:"1px solid #e8edf8"}}>
      ...
      <div className="no-print" style={{display:"flex",gap:8,marginTop:14,flexWrap:"wrap"}}>
        <button onClick={()=>window.print()} className="tap-btn"
